...
// File: x3dOrientationInterpolator.cpp
//
//
...
//-----------------------------------------------
	const MTypeId x3dOrientationInterpolator::typeId( 0x00108F56 );
	const MString x3dOrientationInterpolator::typeName( "x3dOrientationInterpolator" );

	MObject x3dOrientationInterpolator::key;
	MObject x3dOrientationInterpolator::key_cc;
	MObject x3dOrientationInterpolator::keyValue;
	MObject x3dOrientationInterpolator::keyValue_cc;

	MObject x3dOrientationInterpolator::everyFrame;
	MObject x3dOrientationInterpolator::startFrame;
	MObject x3dOrientationInterpolator::stopFrame;
	MObject x3dOrientationInterpolator::secondLength;
	MObject x3dOrientationInterpolator::fps;

	MStatus x3dOrientationInterpolator::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dOrientationInterpolator::initialize()
	{
	...
	void *x3dOrientationInterpolator::creator()
	{
		return new x3dOrientationInterpolator();
	}
