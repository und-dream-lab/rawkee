...
// File: x3dNormalInterpolator.cpp
//
//
...
//-----------------------------------------------
	const MTypeId x3dNormalInterpolator::typeId( 0x00108F4A );
	const MString x3dNormalInterpolator::typeName( "x3dNormalInterpolator" );

	MObject x3dNormalInterpolator::key;
	MObject x3dNormalInterpolator::key_cc;
	MObject x3dNormalInterpolator::keyValue;
	MObject x3dNormalInterpolator::keyValue_cc;
	MObject x3dNormalInterpolator::keyValue_cc_s;
	MObject x3dNormalInterpolator::everyFrame;
	MObject x3dNormalInterpolator::startFrame;
	MObject x3dNormalInterpolator::stopFrame;
	MObject x3dNormalInterpolator::secondLength;
	MObject x3dNormalInterpolator::fps;


	MStatus x3dNormalInterpolator::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dNormalInterpolator::initialize()
	{
	...
	void *x3dNormalInterpolator::creator()
	{
		return new x3dNormalInterpolator();
	}
