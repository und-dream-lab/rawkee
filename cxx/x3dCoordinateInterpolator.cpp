...
// File: x3dCoordinateInterpolator.cpp
//
//
...
//-----------------------------------------------
	const MTypeId x3dCoordinateInterpolator::typeId( 0x00108F16 );
	const MString x3dCoordinateInterpolator::typeName( "x3dCoordinateInterpolator" );

	MObject x3dCoordinateInterpolator::key;
	MObject x3dCoordinateInterpolator::key_cc;
	MObject x3dCoordinateInterpolator::keyValue;
	MObject x3dCoordinateInterpolator::keyValue_cc;
	MObject x3dCoordinateInterpolator::keyValue_cc_s;
	MObject x3dCoordinateInterpolator::everyFrame;
	MObject x3dCoordinateInterpolator::startFrame;
	MObject x3dCoordinateInterpolator::stopFrame;
	MObject x3dCoordinateInterpolator::secondLength;
	MObject x3dCoordinateInterpolator::fps;


	MStatus x3dCoordinateInterpolator::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dCoordinateInterpolator::initialize()
	{
		...
		keyValue = numFn.create("keyValue", "kv", MFnNumericData::k3Float);//kVectorArray);
		...
		keyValue_cc_s = numFn.create("keyValue_cc_s", "kvccs", MFnNumericData::kInt, 0);//kVectorArray);
		numFn.setObject(keyValue_cc_s);
		numFn.setHidden(true);
		addAttribute( keyValue_cc_s );
	...
	void *x3dCoordinateInterpolator::creator()
	{
		return new x3dCoordinateInterpolator();
	}
