...
// File: x3dScalarInterpolator.cpp
//
//
...
//-----------------------------------------------
	const MTypeId x3dScalarInterpolator::typeId( 0x00108F62 );
	const MString x3dScalarInterpolator::typeName( "x3dScalarInterpolator" );

	MObject x3dScalarInterpolator::key;
	MObject x3dScalarInterpolator::key_cc;
	MObject x3dScalarInterpolator::keyValue;
	MObject x3dScalarInterpolator::keyValue_cc;

	MObject x3dScalarInterpolator::everyFrame;
	MObject x3dScalarInterpolator::startFrame;
	MObject x3dScalarInterpolator::stopFrame;
	MObject x3dScalarInterpolator::secondLength;
	MObject x3dScalarInterpolator::fps;


	MStatus x3dScalarInterpolator::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dScalarInterpolator::initialize()
	{
		...
		keyValue = numFn.create("keyValue", "kv", MFnNumericData::kFloat);//kVectorArray);
	...
	void *x3dScalarInterpolator::creator()
	{
		return new x3dScalarInterpolator();
	}
