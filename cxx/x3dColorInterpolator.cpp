...
//-----------------------------------------------
	const MTypeId x3dColorInterpolator::typeId( 0x00108F0F );
	const MString x3dColorInterpolator::typeName( "x3dColorInterpolator" );

	MObject x3dColorInterpolator::key;
	MObject x3dColorInterpolator::key_cc;
	MObject x3dColorInterpolator::keyValue;
	MObject x3dColorInterpolator::keyValue_cc;

	MObject x3dColorInterpolator::everyFrame;
	MObject x3dColorInterpolator::startFrame;
	MObject x3dColorInterpolator::stopFrame;
	MObject x3dColorInterpolator::secondLength;
	MObject x3dColorInterpolator::fps;


	MStatus x3dColorInterpolator::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dColorInterpolator::initialize()
	{
	...
	void *x3dColorInterpolator::creator()
	{
		return new x3dColorInterpolator();
	}
