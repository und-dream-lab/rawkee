...
//-----------------------------------------
MString x3dFileTranslator::defaultExtension() const
{
...
MString x3dFileTranslator::filter() const
{
	MString fileFilter("*.x3d");
	return fileFilter;
}

void * x3dFileTranslator::creator()
{
	return new x3dFileTranslator;
}
