...
//-----------------------------------------
MString x3dvFileTranslator::defaultExtension() const
{
	//returns the default file extension
	MString fileExtension("x3dv");
	return fileExtension;
}

MString x3dvFileTranslator::filter() const
{
	MString fileFilter("*.x3dv");
	return fileFilter;
}

void * x3dvFileTranslator::creator()
{
	return new x3dvFileTranslator;
}
