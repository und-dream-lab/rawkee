...
//x3dIntegerSequencer
//-----------------------------------------------
	const MTypeId x3dIntegerSequencer::typeId( 0x00108F38 );
	const MString x3dIntegerSequencer::typeName( "x3dIntegerSequencer" );

	MObject x3dIntegerSequencer::key;
	MObject x3dIntegerSequencer::key_cc;
	MObject x3dIntegerSequencer::keyValue;
	MObject x3dIntegerSequencer::keyValue_cc;

	MObject x3dIntegerSequencer::everyFrame;
	MObject x3dIntegerSequencer::startFrame;
	MObject x3dIntegerSequencer::stopFrame;
	MObject x3dIntegerSequencer::secondLength;
	MObject x3dIntegerSequencer::fps;


	MStatus x3dIntegerSequencer::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dIntegerSequencer::initialize()
	{
		...
		keyValue = numFn.create("keyValue", "kv", MFnNumericData::kInt);//kVectorArray);
	...
	void *x3dIntegerSequencer::creator()
	{
		return new x3dIntegerSequencer();
	}
