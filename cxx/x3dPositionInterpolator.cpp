...
// File: x3dPositionInterpolator.cpp
//
//
...
//-----------------------------------------------
	const MTypeId x3dPositionInterpolator::typeId( 0x00108F5D );
	const MString x3dPositionInterpolator::typeName( "x3dPositionInterpolator" );

	MObject x3dPositionInterpolator::key;
	MObject x3dPositionInterpolator::key_cc;
	MObject x3dPositionInterpolator::keyValue;
	MObject x3dPositionInterpolator::keyValue_cc;

	MObject x3dPositionInterpolator::everyFrame;
	MObject x3dPositionInterpolator::startFrame;
	MObject x3dPositionInterpolator::stopFrame;
	MObject x3dPositionInterpolator::secondLength;
	MObject x3dPositionInterpolator::fps;


	MStatus x3dPositionInterpolator::compute(const MPlug &plug, MDataBlock &data){
		MStatus stat;
	...
	MStatus x3dPositionInterpolator::initialize()
	{
	...
	void *x3dPositionInterpolator::creator()
	{
		return new x3dPositionInterpolator();
	}
