...
class X3DOrthoViewpointCamera(aom.MPxNode):
    kPluginNodeName = "OrthoViewpoint"
    kPluginNodeId   = aom.MTypeId(0x00108F7A)  # Assign a unique ID
    ...
    @classmethod
    def creator(cls):
        return X3DOrthoViewpointCamera()
