...
#ifndef __x3dCollision_H
#define __x3dCollision_H

class x3dCollision : public MPxTransform
{
	public:
		typedef MPxTransform ParentClass;
		x3dCollision();
		x3dCollision(MPxTransformationMatrix *);
		virtual ~x3dCollision();
