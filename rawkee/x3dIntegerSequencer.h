...
#ifndef __x3dIntegerSequencer_H
#define __x3dIntegerSequencer_H

//-----------------------------------------------
//x3dIntegerSequencer Node Functions and NodeID#
//
	class x3dIntegerSequencer : public MPxLocatorNode
	{
	public:
