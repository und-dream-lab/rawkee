...
#ifndef __x3dBooleanSequencer_H
#define __x3dBooleanSequencer_H

//-----------------------------------------------
//x3dBooleanSequencer Node Functions and NodeID#
//
	class x3dBooleanSequencer : public MPxLocatorNode
	{
	public:
