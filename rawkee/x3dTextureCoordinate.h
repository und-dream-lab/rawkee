...
#ifndef __x3dTextureCoordinate_H
#define __x3dTextureCoordinate_H

class x3dTextureCoordinate : public MPxTransform
{
	public:
		typedef MPxTransform ParentClass;
		x3dTextureCoordinate();
		x3dTextureCoordinate(MPxTransformationMatrix *);
		virtual ~x3dTextureCoordinate();
