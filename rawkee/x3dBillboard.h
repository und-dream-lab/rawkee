...
#ifndef __x3dBillboard_H
#define __x3dBillboard_H

class x3dBillboard : public MPxTransform
{
	public:
		typedef MPxTransform ParentClass;
		x3dBillboard();
		x3dBillboard(MPxTransformationMatrix *);
		virtual ~x3dBillboard();
