...
#ifndef __x3dColorInterpolator_H
#define __x3dColorInterpolator_H

//-----------------------------------------------
//x3dColorInterpolator Node Functions and NodeID#
//
	class x3dColorInterpolator : public MPxLocatorNode
	{
	public:
